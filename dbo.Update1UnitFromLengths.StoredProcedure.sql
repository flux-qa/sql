USE [Lumber]
GO
/****** Object:  StoredProcedure [dbo].[Update1UnitFromLengths]    Script Date: 3/18/2024 4:24:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[Update1UnitFromLengths]
@unitID integer
...
from Units U inner join Items I on U.ob_Items_RID = I.ID
    ...
    where U.ID = @unitID and qtyOnHand > 0
