USE [Lumber]
GO
/****** Object:  StoredProcedure [dbo].[HandledUnitAnalysisRandomSources]    Script Date: 3/18/2024 4:24:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[HandledUnitAnalysisRandomSources]
...
select distinct L.ob_Items_RID as item, 
 count(Distinct datePart(yy, L.dateShipped) * 1000 +
...
itemDays, handledUnits, noLengths
...
where noLengths is null or noLengths > 1
