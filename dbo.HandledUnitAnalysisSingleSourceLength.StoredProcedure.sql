USE [Lumber]
GO
/****** Object:  StoredProcedure [dbo].[HandledUnitAnalysisSingleSourceLength]    Script Date: 3/18/2024 4:24:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[HandledUnitAnalysisSingleSourceLength]
...
where noLengths = 1 or I.oldCode in ('113B',
                                     '228R',
                                     '2CT4',
                                     'A336',
                                     '162A',
